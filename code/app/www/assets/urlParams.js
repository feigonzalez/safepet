/*
	...
	URLparams is a json object with the form {"parameter":"value"}.
	URLparams  is automatically filled with the URL parameters when a page is loaded.
...
function moveTo(newPage,newParams){
	...
	for(key in URLparams){
		appendParams+=`${encodeURIComponent(key)}=${encodeURIComponent(URLparams[key])}&`;
	}
